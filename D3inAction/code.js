...
var svg_tag = d3.select("#graph").append("zoom_box")
    .attr("width", w).attr("height", h)
    //.attr("width", "100%").attr("height", "100%")
    .attr("pointer-events", "all");

var svg = svg_tag.append("g").attr("id", "outer_box");
var g = svg.append("g").attr("id", "inner_box");
